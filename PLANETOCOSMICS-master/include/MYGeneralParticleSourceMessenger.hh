...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:       MYGeneralParticleSourceMessenger.hh
//
// Version:      2.0
// Date:         5/02/04
// Author:       Fan Lei 
...
// Class Description:
//
// The function of the MYGeneralParticleSourceMessenger is to allow the user to
// enter commands either in interactive command line mode or through macros to
// control the MYGeneralParticleSource. 
//
///////////////////////////////////////////////////////////////////////////////
//
// MEMBER FUNCTIONS
// ----------------
//
// MYGeneralParticleSourceMessenger(MYGeneralParticleSource *fPtclGun)
//     Constructor:  Sets up commands.
//
// ~MYGeneralParticleSourceMessenger()
//     Destructor:  Deletes commands.
//
// void SetParticleGun(MYSingleParticleSource *fpg) { fParticleGun = fpg; } ;
//     To selecte the particle gun to be defined/modified. 
// void SetNewValue(G4UIcommand *command, G4String newValues)
//     Uses the appropriate methods in the MYGeneralParticleSource to carry out
//     the user commands.
...
///////////////////////////////////////////////////////////////////////////////
//
#ifndef MYGeneralParticleSourceMessenger_h
#define MYGeneralParticleSourceMessenger_h 1
...
class MYSingleParticleSource;
class MYGeneralParticleSource;

class MYGeneralParticleSourceMessenger: public G4UImessenger
{
public:
  MYGeneralParticleSourceMessenger(MYGeneralParticleSource*);
  ~MYGeneralParticleSourceMessenger();
  ...
  //    these values with the appropriate member function of MYGeneralParticleSource.
  G4String GetCurrentValue(G4UIcommand *command);
...
private:
  MYGeneralParticleSource *fGPS;
  MYSingleParticleSource *fParticleGun;
