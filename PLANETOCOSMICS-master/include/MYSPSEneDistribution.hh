...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:        MYSPSEneDistribution.hh
//
// Version:      1.0
// Date:         5/02/04
// Author:       Fan Lei 
...
#ifndef MYSPSEneDistribution_h
#define MYSPSEneDistribution_h 1
...
public:
  ...
  void Calculate();
  //
  void SetBiasRndm(MYSPSRandomGenerator* a) {eneRndm = a; };
...
private:
  ...
  MYSPSRandomGenerator* eneRndm;

  // Verbosity
  G4int verbosityLevel;

  G4PhysicsOrderedFreeVector ZeroPhysVector ; // for re-set only 
  G4PhysicsOrderedFreeVector* ZeroPhysVector1 ; 
