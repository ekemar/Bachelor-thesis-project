...
struct ccigrf
 {float gg[105];
  ...
  int nm;};   
extern "C"
{extern void f_chang_coord_(int* , char* ,float* ,
 ...
 extern void  t04_s_(int*,float*, float*,float*,float*,float*,
                                            float*,float*,float* );//PVD 11/13/14
 
 extern void mcos_magnetopause_2001_
            (double*, double*,double*,double*,double*,double*);
 
 extern struct cctimereference timereference_;
 extern struct ccprevious previous_; 
 extern struct ccgeopack geopack_;
 extern struct ccgeopack_dbl geopack_dbl_;
 extern struct ccbdip bdip_;
 extern struct ccgeocoef_dbl geocoef_dbl_;
 extern struct ccwhere_in_magnetopause2001 where_in_magnetopause2001_;	
