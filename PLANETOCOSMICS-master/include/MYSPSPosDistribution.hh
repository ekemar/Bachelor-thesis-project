...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:        MYSPSPosDistribution.hh
//
// Version:      1.0
// Date:         5/02/04
// Author:       Fan Lei 
...
//
//  void SetBiasRndm (MYSPSRandomGenerator* a) { posRndm = a ; };
...
///////////////////////////////////////////////////////////////////////////////
//
#ifndef MYSPSPosDistribution_h
#define MYSPSPosDistribution_h 1

#include "G4Navigator.hh"
#include "MYSPSRandomGenerator.hh"

class MYSPSPosDistribution
{
  //
  friend class MYSPSAngDistribution;
public:
  MYSPSPosDistribution (); 
  ~MYSPSPosDistribution ();
...
private:
  ...
  //
  MYSPSRandomGenerator* posRndm; // biased random generator
  // Verbosity
