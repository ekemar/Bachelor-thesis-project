...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:        MYSPSAngDistribution.hh
//
// Version:      1.0
// Date:         5/02/04
// Author:       Fan Lei 
...
//
//  void SetPosDistribution(MYSPSPosDistribution* a) {posDist = a; };
//    Sets the required position generator, required for determining the cosine-law distribution
// 
//  void SetBiasRndm (MYSPSRandomGenerator* a)
...
///////////////////////////////////////////////////////////////////////////////
//
#ifndef MYSPSAngDistribution_h
#define MYSPSAngDistribution_h 1
...
public:
  ...
  //
  void SetPosDistribution(MYSPSPosDistribution* a) {posDist = a; };
  void SetBiasRndm(MYSPSRandomGenerator* a) {angRndm = a;};
...
private:
  ...
  //
  MYSPSPosDistribution* posDist;  // need it here for the cosine-law distri 
  MYSPSRandomGenerator* angRndm; // biased random generator
