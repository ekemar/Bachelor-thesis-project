...
public:
  ...
  void OutputCollection( std::ofstream &outs);           // Output to an ofstream (previously opened file
  ...
  void ReadCollection( std::ifstream &ins);            // Read from an ifstream, previously opened file
