#ifndef PLANETOCOSSpenvisManager_HH
#define PLANETOCOSSpenvisManage_HH 1
#include"G4ios.hh"
...
public:
   ...
   ~PLANETOCOSSpenvisManager(); 
   static PLANETOCOSSpenvisManager* GetInstance();
...
private:
   static PLANETOCOSSpenvisManager* instance;
