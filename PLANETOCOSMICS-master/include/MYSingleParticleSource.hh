...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:        MYSingleParticleSource.hh
//
// Version:      1.0
// Date:         5/02/04
// Author:       Fan Lei 
...
///////////////////////////////////////////////////////////////////////////////
//
#ifndef MYSingleParticleSource_h
#define MYSingleParticleSource_h 1
...
class MYSingleParticleSource : public G4VPrimaryGenerator
{
public:
  MYSingleParticleSource (); 
  ~MYSingleParticleSource ();
  void GeneratePrimaryVertex(G4Event *evt);
  //
  MYSPSPosDistribution* GetPosDist() {return posGenerator;};
  MYSPSAngDistribution* GetAngDist() {return angGenerator;};
  MYSPSEneDistribution* GetEneDist() {return eneGenerator;};
  MYSPSRandomGenerator* GetBiasRndm() {return biasRndm;};
...
private:
  ...
  MYSPSPosDistribution* posGenerator;
  MYSPSAngDistribution* angGenerator;
  MYSPSEneDistribution* eneGenerator;
  MYSPSRandomGenerator* biasRndm;
  //
