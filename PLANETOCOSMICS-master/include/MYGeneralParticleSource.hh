...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:       MYGeneralParticleSource.hh
//
// Version:      2.0
// Date:         5/02/04
// Author:       Fan Lei 
...
//  MYSingleParticleSource* GetCurrentSource()
...
///////////////////////////////////////////////////////////////////////////////
//
#ifndef MYGeneralParticleSource_H
#define MYGeneralParticleSource_H 1
...
class MYGeneralParticleSource : public G4VPrimaryGenerator
{
  //
public:
  ...
  void SetCurrentSourceto(G4int) ;
  void SetCurrentSourceIntensity(G4double);
  MYSingleParticleSource* GetCurrentSource() {return currentSource;};
...
private:
  ...
  MYSingleParticleSource* currentSource;
  std::vector <MYSingleParticleSource*> sourceVector;
  std::vector <G4double> sourceIntensity;
  std::vector <G4double>sourceProbability;

  MYGeneralParticleSourceMessenger* theMessenger;
