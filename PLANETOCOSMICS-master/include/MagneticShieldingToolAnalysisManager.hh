...
class MagneticShieldingToolAnalysisManager
{
public:
  
  ~MagneticShieldingToolAnalysisManager();
   static MagneticShieldingToolAnalysisManager* GetInstance();
  ...
  //Rigidity ForDiffrent position
   ...
   void OpenCutoffVsDirectionFile(G4String fileName,G4String CoordSys, bool Append);
   ...
   void CloseAsciiFile();
private:
  static MagneticShieldingToolAnalysisManager* instance;
