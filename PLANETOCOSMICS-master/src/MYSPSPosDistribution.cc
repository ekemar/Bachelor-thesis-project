...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:        MYSPSPosDistribution.cc
//
// Version:      1.0
// Date:         5/02/04
// Author:       Fan Lei 
...
MYSPSPosDistribution::MYSPSPosDistribution()
{
...
void MYSPSPosDistribution::SetPosDisType(G4String PosType)
{
  SourcePosType = PosType;
}

void MYSPSPosDistribution::SetPosDisShape(G4String shapeType)
{
  Shape = shapeType;
}

void MYSPSPosDistribution::SetCentreCoords(G4ThreeVector coordsOfCentre)
{
  CentreCoords = coordsOfCentre;
}

void MYSPSPosDistribution::SetPosRot1(G4ThreeVector posrot1)
{
  // This should be x'
  Rotx = posrot1;
  if(verbosityLevel == 2)
...
void MYSPSPosDistribution::SetPosRot2(G4ThreeVector posrot2)
{
...
void MYSPSPosDistribution::SetHalfX(G4double xhalf)
{
  halfx = xhalf;
}

void MYSPSPosDistribution::SetHalfY(G4double yhalf)
{
  halfy = yhalf;
}

void MYSPSPosDistribution::SetHalfZ(G4double zhalf)
{
  halfz = zhalf;
}

void MYSPSPosDistribution::SetRadius(G4double rad)
{
  Radius = rad;
}

void MYSPSPosDistribution::SetRadius0(G4double rad)
{
  Radius0 = rad;
}

void MYSPSPosDistribution::SetBeamSigmaInR(G4double r)
{
  SR = r;
  SX = SY = r/std::sqrt(2.);
}

void MYSPSPosDistribution::SetBeamSigmaInX(G4double r)
{
  SX = r;
}

void MYSPSPosDistribution::SetBeamSigmaInY(G4double r)
{
  SY = r;
}

void MYSPSPosDistribution::SetParAlpha(G4double paralp)
{
  ParAlpha = paralp;
}

void MYSPSPosDistribution::SetParTheta(G4double parthe)
{
  ParTheta = parthe;
}

void MYSPSPosDistribution::SetParPhi(G4double parphi)
{
  ParPhi = parphi;
}

void MYSPSPosDistribution::GenerateRotationMatrices()
{
...
void MYSPSPosDistribution::ConfineSourceToVolume(G4String Vname)
{
  VolName = Vname;
  if(verbosityLevel == 2)
...
void MYSPSPosDistribution::GeneratePointSource()
{
...
void MYSPSPosDistribution::GeneratePointsInBeam()
{
  G4double x, y, z;
...
void MYSPSPosDistribution::GeneratePointsInPlane()
{
  G4double x, y, z;
  G4double expression;
  G4ThreeVector RandPos;
...
void MYSPSPosDistribution::GeneratePointsOnSurface()
{
...
void MYSPSPosDistribution::GeneratePointsInVolume()
{
  G4ThreeVector RandPos;
  G4double tempx, tempy, tempz;
  G4double x, y, z;
...
G4bool MYSPSPosDistribution::IsSourceConfined()
{
...
G4ThreeVector MYSPSPosDistribution::GenerateOne()
{
  //
