...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:       MYGeneralParticleSourceMessenger.cc
//
// Version:      2.0
// Date:         5/02/04
// Author:       Fan Lei 
...
///////////////////////////////////////////////////////////////////////////////
//
MYGeneralParticleSourceMessenger::MYGeneralParticleSourceMessenger
  (MYGeneralParticleSource *fPtclGun) 
...
void MYGeneralParticleSourceMessenger::SetNewValue(G4UIcommand *command, G4String newValues)
{
  if(command == typeCmd)
    {
      fParticleGun->GetPosDist()->SetPosDisType(newValues);
      G4cout << " MYGeneralParticleSourceMessenger - Warning:" << G4endl
	...
	fParticleGun->GetEneDist()->EpnEnergyHisto(histpointCmd->GetNew3VectorValue(newValues));
      G4cout << " MYGeneralParticleSourceMessenger - Warning: The command is obsolete and will be removed soon. Please try to use the new structured commands!" << G4endl;
    }
...
G4String MYGeneralParticleSourceMessenger::GetCurrentValue(G4UIcommand *)
{
  G4String cv;
...
void MYGeneralParticleSourceMessenger::IonCommand(G4String newValues)
{
  fShootIon = true;
