...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:        MYSPSAngDistribution.cc
//
// Version:      1.0
// Date:         5/02/04
// Author:       Fan Lei 
...
MYSPSAngDistribution::MYSPSAngDistribution()
{
...
//
void MYSPSAngDistribution::SetAngDistType(G4String atype)
{
...
void MYSPSAngDistribution::DefineAngRefAxes(G4String refname, G4ThreeVector ref)
{
  if(refname == "angref1")
    AngRef1 = ref.unit(); // x'
...
void MYSPSAngDistribution::SetMinTheta(G4double mint)
{
  MinTheta = mint;
}

void MYSPSAngDistribution::SetMinPhi(G4double minp)
{
  MinPhi = minp;
}

void MYSPSAngDistribution::SetMaxTheta(G4double maxt)
{
  MaxTheta = maxt;
}

void MYSPSAngDistribution::SetMaxPhi(G4double maxp)
{
  MaxPhi = maxp;
}

void MYSPSAngDistribution::SetBeamSigmaInAngR(G4double r)
{
  DR = r;
}

void MYSPSAngDistribution::SetBeamSigmaInAngX(G4double r)
{
  DX = r;
}

void MYSPSAngDistribution::SetBeamSigmaInAngY(G4double r)
{
  DY = r;
}

void MYSPSAngDistribution::UserDefAngTheta(G4ThreeVector input)
{
...
void MYSPSAngDistribution::UserDefAngPhi(G4ThreeVector input)
{
...
void MYSPSAngDistribution::SetFocusPoint(G4ThreeVector input)
{
  FocusPoint = input;
}

void MYSPSAngDistribution::SetUserWRTSurface(G4bool wrtSurf)
{
...
void MYSPSAngDistribution::SetUseUserAngAxis(G4bool userang)
{
...
void MYSPSAngDistribution::GenerateBeamFlux()
{
  G4double theta, phi;
  G4double px, py, pz;
...
void MYSPSAngDistribution::GenerateFocusedFlux()
{
...
void MYSPSAngDistribution::GenerateIsotropicFlux()
{
...
void MYSPSAngDistribution::GenerateCosineLawFlux()
{
...
void MYSPSAngDistribution::GeneratePlanarFlux()
{
  // particle_momentum_direction now contains unit momentum vector.
...
void MYSPSAngDistribution::GenerateUserDefFlux()
{
...
G4double MYSPSAngDistribution::GenerateUserDefTheta()
{
...
G4double MYSPSAngDistribution::GenerateUserDefPhi()
{
  // Create cumulative histogram if not already done so. Then use RandFlat
  //::shoot to generate the output Theta value.
...
//
void MYSPSAngDistribution::ReSetHist(G4String atype)
{
  if (atype == "theta") {
    UDefThetaH = IPDFThetaH = ZeroPhysVector ;
    IPDFThetaExist = false ;}
...
G4ParticleMomentum MYSPSAngDistribution::GenerateOne()
{
  // Angular stuff
  if(AngDistType == "iso")
