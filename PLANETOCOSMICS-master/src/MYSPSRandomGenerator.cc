...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:        MYSPSRandomGenerator.cc
//
// Version:      1.0
// Date:         5/02/04
// Author:       Fan Lei 
...
//MYSPSRandomGenerator* MYSPSRandomGenerator::instance = 0;

MYSPSRandomGenerator::MYSPSRandomGenerator()
{
...
//MYSPSRandomGenerator* MYSPSRandomGenerator::getInstance ()
//{
//  if (instance == 0) instance = new MYSPSRandomGenerator();
//  return instance;
//}

// Biasing methods

void MYSPSRandomGenerator::SetXBias(G4ThreeVector input)
{  
  G4double ehi, val;
  ehi = input.x();
  val = input.y();
...
void MYSPSRandomGenerator::SetYBias(G4ThreeVector input)
{
  G4double ehi, val;
  ehi = input.x();
  val = input.y();
...
void MYSPSRandomGenerator::SetZBias(G4ThreeVector input)
{
  G4double ehi, val;
  ehi = input.x();
  val = input.y();
...
void MYSPSRandomGenerator::SetThetaBias(G4ThreeVector input)
{
  G4double ehi, val;
  ehi = input.x();
  val = input.y();
...
void MYSPSRandomGenerator::SetPhiBias(G4ThreeVector input)
{
  G4double ehi, val;
  ehi = input.x();
  val = input.y();
...
void MYSPSRandomGenerator::SetEnergyBias(G4ThreeVector input)
{
  G4double ehi, val;
  ehi = input.x();
  val = input.y();
...
void MYSPSRandomGenerator::SetPosThetaBias(G4ThreeVector input)
{
  G4double ehi, val;
  ehi = input.x();
  val = input.y();
...
void MYSPSRandomGenerator::SetPosPhiBias(G4ThreeVector input)
{
  G4double ehi, val;
  ehi = input.x();
  val = input.y();
...
void MYSPSRandomGenerator::ReSetHist(G4String atype)
{
  if ( atype == "biasx") {
    XBias = false ;
    IPDFXBias = false;
...
G4double MYSPSRandomGenerator::GenRandX()
{
  if(verbosityLevel >= 1)
...
G4double MYSPSRandomGenerator::GenRandY()
{
  if(verbosityLevel >= 1)
...
G4double MYSPSRandomGenerator::GenRandZ()
{
  if(verbosityLevel >= 1)
...
G4double MYSPSRandomGenerator::GenRandTheta()
{
  if(verbosityLevel >= 1)
    {
...
G4double MYSPSRandomGenerator::GenRandPhi()
{
  if(verbosityLevel >= 1)
...
G4double MYSPSRandomGenerator::GenRandEnergy()
{
  if(verbosityLevel >= 1)
...
G4double MYSPSRandomGenerator::GenRandPosTheta()
{
  if(verbosityLevel >= 1)
    {
...
G4double MYSPSRandomGenerator::GenRandPosPhi()
{
  if(verbosityLevel >= 1)
