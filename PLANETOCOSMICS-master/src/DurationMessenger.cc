...
{ theDurationManager = aDurationManager;
 ...
 //directories
  DurationDir = new G4UIdirectory("/PLANETOCOS/DURATION/");
...
// Duration commands
  ...
  SetMaxTotalDurationCmd = new
               G4UIcmdWithADoubleAndUnit("/PLANETOCOS/DURATION/SetMaxTotalDuration",this);
  ...
  SetMaxRunDurationCmd = new
               G4UIcmdWithADoubleAndUnit("/PLANETOCOS/DURATION/SetMaxRunDuration",this);
  ...
  SetMaxEventDurationCmd = new
               G4UIcmdWithADoubleAndUnit("/PLANETOCOS/DURATION/SetMaxEventDuration",this);
